---
layout: post
title: EIT for sign languages
status: hidden
---

Electrical Impedance Tomography (EIT) is a low-cost imaging process that consists of studying the impedance distribution inside a tangible object using electrical current. 
